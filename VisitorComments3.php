...
-->
	...
	<body>
        ...
        <?php
        $dir = "./comments";
        //Checks if the directory exists if not it creates it with appropiate permissions
        if (is_dir($dir)) {
            //Checks if the submit button was used to get here if so it begins the code execution 
            if (isset($_POST['save'])) {
                ...
                if (empty($_POST['name'])) {
                    ...
                    if ($fileHandle === false) {
                        ...
                        if (flock($fileHandle, LOCK_EX)) {
                            ...
                            echo "There was an error locking the file \"" . htmlentities($saveFileName) . "\".<br>\n";    
                        }
                        fclose($fileHandle);
                    }
                }
